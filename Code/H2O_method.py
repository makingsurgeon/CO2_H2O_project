...
# Function for predicting H2O w.t.%
def H2O_prediction(args):
    ...
    for i in range(np.shape(reduced_data)[0]):
        if ( 2 *reduced_data[i ,3 ] + 2 *reduced_data[i ,4 ] + 3 *reduced_data[i ,5 ] +reduced_data[i ,6 ]
            +reduced_data[i ,8 ] +reduced_data[i ,9 ] +reduced_data[i ,10 ] +reduced_data[i ,11]) > 0:
            idx1.append(i)
    ...
    NBO = 2* (reduced_data[:, 6] + reduced_data[:, 8] + reduced_data[:, 9] + reduced_data[:, 10] + reduced_data[:,
                                                                                                    11] - reduced_data[
                                                                                                          :, 5])
    NBOO = NBO / (2 * reduced_data[:, 3] + 2 * reduced_data[:, 4] + 3 * reduced_data[:, 5] + reduced_data[:,
                                                                                             6] + reduced_data[:,
                                                                                                  8] + reduced_data[:,
                                                                                                       9] + reduced_data[
                                                                                                            :,
    ...
    NBO1 = 2 * (reduced_data2[:, 6] + reduced_data2[:, 8] + reduced_data2[:, 9] + reduced_data2[:, 10] + reduced_data2[
                                                                                                         :,
                                                                                                         11] - reduced_data2[
                                                                                                               :, 5])
    NBOO1 = NBO1 / (2 * reduced_data2[:, 3] + 2 * reduced_data2[:, 4] + 3 * reduced_data2[:, 5] + reduced_data2[:,
                                                                                                  6] + reduced_data2[:,
                                                                                                       8] + reduced_data2[
                                                                                                            :,
                                                                                                            9] + reduced_data2[
...
# Function for predicting CO2 w.t.%
def CO2_prediction(args):
    ...
    NBO = 2 * (reduced_data[:, 7] + reduced_data[:, 9] + reduced_data[:, 10] + reduced_data[:, 11] + reduced_data[:,
                                                                                                     12] - reduced_data[
                                                                                                           :, 6])
    NBOO = NBO / (2 * reduced_data[:, 4] + 2 * reduced_data[:, 5] + 3 * reduced_data[:, 6] + reduced_data[:,
                                                                                             7] + reduced_data[:,
                                                                                                  9] + reduced_data[:,
                                                                                                       10] + reduced_data[
                                                                                                             :,
    ...
    NBO1 = 2 * (reduced_data2[:, 7] + reduced_data2[:, 9] + reduced_data2[:, 10] + reduced_data2[:, 11] + reduced_data2[
                                                                                                          :,
                                                                                                          12] - reduced_data2[
                                                                                                                :, 6])
    NBOO1 = NBO1 / (2 * reduced_data2[:, 4] + 2 * reduced_data2[:, 5] + 3 * reduced_data2[:, 6] + reduced_data2[:,
                                                                                                  7] + reduced_data2[:,
                                                                                                       9] + reduced_data2[
                                                                                                            :,
                                                                                                            10] + reduced_data2[
